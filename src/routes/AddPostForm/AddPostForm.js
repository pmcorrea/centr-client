      ...
      <>
        ...
        <div className="AddPost__form_contaner">
          ...
          >
            ...
            <label htmlFor="folder_select_menu" id="folder_select_menu_label">
              select folder
            </label>
            <select
              className="AddPost__select"
              id="folder_select_menu"
              onChange={(e) => this.updatePostFolder(e.target.value, folders)}
            >
              {folders.map((folder) => (
                <option
                  className="AddPost__option"
                  value={folder.folder_name}
                  key={`folder.folder_name_${this.randomKey()}`}
                >
                  {folder.folder_name}
                </option>
              ))}
            ...
            <label
              htmlFor="post_visibility_option"
              id="folder_select_menu_label"
            >
              select visibility
            </label>
            <select
              className="AddPost__select"
              id="post_visibility_option"
              onChange={(e) =>
                this.updatePostVisibility(e.target.value, folders)
              }
            >
              <option
                className="AddPost__option"
              ...
              <option className="AddPost__option" value="Public" key={"Public"}>
                Public
              </option>
            </select>
            ...
            <button
              ...
              type="submit"
              disabled={this.validateSubmission()}
            >
              submit
            </button>
          </form>
